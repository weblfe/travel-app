...
var rootCmd = &cobra.Command{
		Use:   "cmder",
		Short: "travel-app deploy cli",
		Long:  `travel-app deploy for app, config deploy  etcd configure center , docker server register`,
...
func initConfig() {
		if cfgFile != "" {
				...
				// Search config in home directory with name ".cmder" (without extension).
				viper.AddConfigPath(home)
				viper.SetConfigName(".cmder")
		}
