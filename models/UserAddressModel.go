...
func (this *UserAddressModel) CreateIndex() {
		// unique mobile
		...
		// 创建索引
		_ = this.Collection().EnsureIndexKey("doorplate")
		_ = this.Collection().EnsureIndexKey("city", "district")
		_ = this.Collection().EnsureIndexKey("country", "province")
		_ = this.Collection().EnsureIndexKey("longitude", "latitude")
		_ = this.Collection().EnsureIndexKey("userId", "type", "state")
		_ = this.Collection().EnsureIndexKey("countryId", "provinceId", "cityId", "districtId")
}
